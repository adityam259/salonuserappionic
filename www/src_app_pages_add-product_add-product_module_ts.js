"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["src_app_pages_add-product_add-product_module_ts"],{
...
/* harmony import */ var _add_product_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-product.page */ 65933);
...
/* harmony import */ var _add_product_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add-product-routing.module */ 21578);
/* harmony import */ var _add_product_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add-product.page */ 65933);
...
/* harmony import */ var _D_projects_salon_user_user_app_salon_node_modules_ngtools_webpack_src_loaders_direct_resource_js_add_product_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./add-product.page.html */ 64136);
...
let AddProductPage = class AddProductPage {
    ...
    onSubmit() {
        ...
        this.requestServiceService.postHttpCall("submitProductImage", formData).subscribe((data) => {
            if (data.status === 'SUCCESS') {
                ...
                console.log(data);
                this.presentAlert(data.status, data.message);
                this.goToOtherPage('add-product');
            }
        });
    }
...
AddProductPage = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Component)({
        selector: 'app-add-product',
        template: _D_projects_salon_user_user_app_salon_node_modules_ngtools_webpack_src_loaders_direct_resource_js_add_product_page_html__WEBPACK_IMPORTED_MODULE_0__["default"],
